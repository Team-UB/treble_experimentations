...
if [ "$#" -le 1 ];then
	echo "Usage: $0 <android-10.0> <carbon|lineage|rr|tub> '# of jobs'"
	exit 0
fi
...
if [ "$rom" == "carbon" ];then
	...
	repo init -u https://github.com/abun880007/android.git -b TUB-10 --depth=1
fi

if [ -d .repo/local_manifests ] ;then
	( cd .repo/local_manifests; git fetch; git checkout origin/TUB-10)
else
	git clone https://github.com/team-ub/treble_manifest .repo/local_manifests -b TUB-10
fi
